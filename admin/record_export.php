...
function exportRecord(){
	...
	window.location.href='./download.php?act=record&starttime='+encodeURIComponent(starttime)+'&endtime='+encodeURIComponent(endtime)+'&uid='+encodeURIComponent(uid)+'&type='+encodeURIComponent(type)+'&csrf_token='+encodeURIComponent(csrfToken);
	return false;
}
